  ...
  const handleCompletePayment = async () => {
    ...
    const paymentData = {
      items: cartItems.map(item => ({
        ...
        // Include roofing spec data for zn items
        custom_ds_roofing_spec: item.custom_ds_roofing_spec || null,
        // Include generated description
...
//eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  const isActionButtonDisabled = () => {
    console.log("DS - Validating action button: invoiceSubmitted", invoiceSubmitted);
    console.log("DS - Validating action button: isProcessingPayment", isProcessingPayment);
    console.log("DS - Validating action button: isB2C", isB2C);
    console.log("DS - Validating action button: outstandingAmount", outstandingAmount);
